...
<style>
   *{margin: 0;padding: 0;box-sizing: border-box}
	...
	.checkBox textarea{
		width: 96%;height: 200px; margin: 0 2%;
	...
	.footBtwrap>li>#agreeButton{display: block; width: 100%;height: 100%; font-size: 20px;text-align: center;line-height: 60px;}
	.fpmgBt1{background-color: #fff;color:#888}
	#agreeButton{background-color: #1337b1;color: #fff}
	</style>
</head>
<body>
<div action="" id="joinForm">
      <ul class="join_box">
         <li class="checkBox check02">
            ...
            <textarea name="agreed" id="agreed">
제1조(목적)
이 약관은 (주)2렇게잘하조(전자거래 사업자)가 운영하는 홈페이지(이하 "쇼핑몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 (주)2렇게잘하조와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
※ 「PC통신 등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」


제2조(정의)
① "쇼핑몰"이란 사업자가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 "쇼핑몰"을 운영하는 사업자의 의미로도 사용합니다.
...
② "쇼핑몰"과 이용자간에 제기된 전자거래 소송에는 한국법을 적용합니다.
      ...
      <ul class="footBtwrap clearfix">
        ...
        <li><button id="agreeButton">동의</button></li>
		<!-- <li><input type="submit" value="동의" class="fpmgBt2"/></li> -->
      </ul>
	</div>

   <script>
	document.getElementById("agreeButton").addEventListener("click", function () {
		// 동의 버튼을 클릭하면 회원가입 페이지로 이동
		window.location.href = "./join.html?agreed=true";
	});
</script>
</body>
</html>