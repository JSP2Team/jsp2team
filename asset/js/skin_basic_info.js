...
function companyInfo( targetSelector ) {
	...
	if ( BASIC_CONFIG.co_address ) coInfoGon += '<li><span class="title">주소 : </span><span class="desc">' + BASIC_CONFIG.co_address + ' ';
	if ( BASIC_CONFIG.co_address_detail ) coInfoGon += BASIC_CONFIG.co_address_detail;
	coInfoGon += '</span></li>';
