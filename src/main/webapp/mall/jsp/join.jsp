...
#userid {
    flex: 1; /* 입력 창이 남는 공간을 차지하도록 설정 */
    margin-right: -20px; /* 입력 창과 버튼 사이에 간격 추가 */
}
...
button.idcheck{
	 ...
	 color: white;
	 font-size: 18px;
	 border: none; /* 버튼 주변의 보더를 없앰 */
     outline: none; /* 클릭 포커스 시의 아웃라인을 제거 (선택 사항) */
     position: absolute; /* Position the button */
   	 left: 320px; /* Adjust the distance from the right edge */
    }
...
<section class="login-form" align="center">
    ...
    <form action="/mall/jsp/join.bo" method="post" name="joinForm" id="joinform">
          ...
          <div class="int-area" id="int-area" align="center">
            <input type="text" name="userid" id="userid" autocomplete="off" required>
            <label for="id">아이디</label>
            <button type="button" class="idcheck" onclick="checkId(joinForm.userid.value);">중복확인</button>
        </div>
        <div class="int-area">
