											...
											<div class='module_wrap' data-layout-fullsize='no'>
												<div class='module_container' data-padding-top='80'
													...
													<div class="order_body payment">
														...
														<form
															action="${pageContext.request.contextPath}/jsp/sign.si"
															...
															<div id="div-orderer-info" class="payment_info">
																<div class="info_area">
																	...
																	<div class="payment_method_area">
																		<div id="payment_method_lay"
																			class="payment_method tab_radio"></div>
																		<div id="payment_receipt_lay" class="info_cont"></div>
																	</div>
																	<div class="info_cont hide" id="free_payment_info">
																		<input class="hide" type="radio" id="free_method"
																			value="account_tranfer">
																		<p>결제할 금액이 없습니다.</p>
																	</div>
																		...
																		<div class="line_box payment">
																			<div class="agree">
																				<p class="item radio_checkbox_type2">
																					<label for="agree_terms"> <input
																						type="checkbox" id="agree_terms"
																						name="agree_payment_terms" class="chks" value="Y">&nbsp;&nbsp;&nbsp;&nbsp;
																						<em>결제 조건 확인 및 배송, 반품, 교환<br> 조건에 대해
																							확인하였습니다. <span class="span txt_point">(필수)</span></em>
																					</label>
																					<button type="button"
																						class="btn_agree_detail btn-show-layer"
																						data-key="member_agree">보기</button>
																				</p>
																			</div>
																			<div id="create_order_button_lay"
																				class="wrap_btn_payment">
																				<button type="submit" id="PaymentLibrary_PayButton"
																					class="payment-lib-pay-button">결제하기</button>
																			</div>
																		</div>
																	</div>
																	<!--// price_box -->
...
<!-- 1.21 깃허브 sign 예전꺼에다가 세션 수정되어 있어서 다시 jsp수정/ insert 복구 -->
